                        ...
                        <div class="iq-card">
                            ...
                            <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                                                    ...
                                                    <div class="modal-body">
                                                        <form class="form-horizontal" method="post"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input name="tw2" id="tw2" type="text"
                                                                    class="form-control">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>RPD Triwulan 3</label>
                                                                <input name="tw3" id="tw3" type="text"
                                                                    class="form-control">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>RPD Triwulan 4</label>
                                                                <input name="tw4" id="tw4" type="text"
                                                                    class="form-control">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Prodi</label>
                                                                <select name="id_unit" id="tambahunit"
                                                                    aria-hidden="true"
                                                                    data-select2-id="select2-data-58-6f47"
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right"
                                                ...
                                                <a class="dropdown-item" href="" onclick="printDiv()"><i
                                                        class="ri-printer-fill mr-2" onclick="printDiv()"></i>Print</a>
                                ...
                                <div class="iq-card-body">
                                    @can('pagu_create')
                                        <button class="btn btn-primary" data-toggle="modal" title="Tambah PAGU"
                                            data-original-title="Tambah PAGU" data-target="#tambahpagu">
                                    ...
                                    <span class="table-add float-right mb-3 mr-2">
                                        <div class="form-group row">
                                            <form action="{{ url('/pagu/filtertahun') }}" method="GET">
                                                <div class="row mr-3">
                                                    <div class="col mr-1">
                                                        <select class="form-control filter sm-8" name="tahun"
                                                            id="input">
                                    ...
                                    <div class="table-responsive" style="overflow-x:scroll;">
                                        ...
                                        <table id="mypagu" class="table mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="text-center"><a href="#">{{ $num }}</a>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>{{ 'Rp ' . number_format($pagu[$a]->tw1) }}</td>
                                                    <td>{{ 'Rp ' . number_format($pagu[$a]->tw2) }}</td>
                                                    <td>{{ 'Rp ' . number_format($pagu[$a]->tw3) }}</td>
                                                    <td>{{ 'Rp ' . number_format($pagu[$a]->tw4) }}</td>
                                                    <td>
                                                        <div class="flex align-items-center list-user-action">
                                                            <div class="row">
                                                                @can('pagu_update')
                                                                    <a class="iq-bg-warning" data-toggle="modal"
                                                                ...
                                                                @endcan
                                                                @can('pagu_delete')
                                                                    <a class="pagu-confirm iq-bg-danger"
                                                                        data-toggle="tooltip" data-placement="top"
                                                                        title="" data-original-title="Delete"
                                                                        href="{{ url('/pagu/delete/' . base64_encode($pagu[$a]->id)) }}"><i
                                                ...
                                                <div class="modal fade" role="dialog"
                                                    id="update_pagu<?= $pagu[$a]->id ?>" style="overflow:hidden;">
                                                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                            ...
                                                            <div class="modal-body">
                                                                <form class="form-horizontal" method="post"
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input name="tw1" id="tw1"
                                                                            type="text"
                                                                            value="{{ old('tw1', $pagu[$a]->tw1) }}"
                                                                            class="form-control">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label>Triwulan 2</label>
                                                                        <input name="tw2" id="tw2"
                                                                            type="text"
                                                                            value="{{ old('tw2', $pagu[$a]->tw2) }}"
                                                                            class="form-control">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label>Triwulan 3</label>
                                                                        <input name="tw3" id="tw3"
                                                                            type="text"
                                                                            value="{{ old('tw3', $pagu[$a]->tw3) }}"
                                                                            class="form-control">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label>Triwulan 4</label>
                                                                        <input name="tw4" id="tw4"
                                                                            type="text"
                                                                            value="{{ old('tw4', $pagu[$a]->tw4) }}"
                                                                            class="form-control">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label>Prodi</label>
                                                                        <select name="id_unit" id="updateunit"
                                                                            aria-hidden="true"
                                                                            data-select2-id="select2-data-58-6f57"
                                                                            style="width: 100%;height:50px;line-height:45px;color:#a09e9e;background:#00000000;border:1px solid #f1f1f1;border-radius:5px">
                                                                            @foreach ($unit2 as $unit)
                                                                                <option value="{{ $unit->id }}"
                                                                                    {{ $unit->id == $pagu[$a]->id_unit ? 'selected' : '' }}>
                                                                                    {{ $unit->nama_unit }}</option>
                                                                            @endforeach
                                                                        </select>
                                                                    </div>
