<div class="modal fade" tabindex="-1" role="dialog" id="veriftor{{$join[$a]->tor_id}}">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="iq-card">
                    <div class="iq-card-header d-flex justify-content-between">
                        <div class="iq-header-title">
                            <h4 class="card-title">Status Pengajuan Kegiatan</h4>
                        </div>
                    </div>
                ...
                <div class="iq-card">
                    <div class="iq-card-header d-flex justify-content-between">
                        <div class="iq-header-title">
                            <h4 class="card-title">Verifikasi Kegiatan</h4>
                        </div>
                    </div>
                    <div class="iq-card-body">
