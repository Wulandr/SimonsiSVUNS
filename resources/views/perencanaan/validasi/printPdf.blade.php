                ...
                <div class="table-responsive">
                    <table id="datatable" class="table table-striped table-bordered" style="border-collapse:collapse;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td></td>
                                <td colspan="7">{!!$tor[$t]->latar_belakang!!}</td>
                            </tr>
                            ...
                            <tr>
                                <td></td>
                                <td colspan="7">{!!$tor[$t]->rasionalisasi!!}</td>
                            </tr>
                            ...
                            <tr>
                                <td></td>
                                <td colspan="7">{!!$tor[$t]->mekanisme!!}</td>
                            </tr>
                            ...
                            <tr>
                                <td></td>
                                <td colspan="7">{!!$tor[$t]->keberlanjutan!!}</td>
                            </tr>
                            ...
                            <tr>
                                <td></td>
                                <td colspan="7">Penanggung jawab dari kegiatan ini adalah {{$tor[$t]->nama_pic }}</td>
                            </tr>
                            <tr>
                        ...
                        <div class="table-responsive">
                            <table id="datatable" class="table table-striped table-bordered" style="border-collapse:collapse;">
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        <td colspan="1">Wakil Dekan Akademik, <br />Riset, dan Kemahasiswaan
                                            <br />
                                            <br />
                                            <br />
                                            <b>Agus Dwi Priyanto, S.S., M.CALL</b><br />
