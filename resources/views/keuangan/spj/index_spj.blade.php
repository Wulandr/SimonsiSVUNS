                                                        ...
                                                        @foreach ($status_keu as $b)
                                                            @if ($a->id_status == $b->id && $b->kategori == 'SPJ')
                                                                ...
                                                                @if ($RoleLogin === 'Staf Keuangan')
                                                                    <?php $tidakada_status = '<button type="button" class="badge border border-primary text-primary" data-toggle="modal" data-target="#status_spj' . $tor[$m]->id . '">' . $b->nama_status . '</button>&nbsp<span type="button" class="badge badge-dark" data-toggle="modal" data-target="#validasi_spj' . $tor[$m]->id . '"><i class="ri-edit-fill"></i></span>';
                                                                    ?>
                                                                    @if ($b->nama_status == 'Revisi')
                                                                        <?php $tidakada_status = '<button type="button" class="badge border border-primary text-primary" data-toggle="modal" data-target="#status_spj' . $tor[$m]->id . '">' . $b->nama_status . '</button>&nbsp<span type="button" class="badge badge-secondary" data-toggle="modal" data-target="#revisi_spj' . $tor[$m]->id . '"><i class="las la-comment"></i></span>';
                                                                        ?>
                                                            ...
                                                            @if ($a->id_status == $b->id && $b->kategori == 'SPJ')
                                                                ...
                                                                @elseif ($RoleLogin === 'Staf Keuangan')
                                                                    @if ($b->nama_status == 'Verifikasi')
                                                                        <?php $file = '<a href="' . url('/detail_spj/') . '?idtor=' . base64_encode($tor[$m]->id) . '"><button class="btn btn-sm bg-info rounded-pill" title="Detail File SPJ"><i class="las la-external-link-alt"></i></i></button></a>&nbsp<button class="btn btn-sm bg-info rounded-pill" title="Input Bukti Transfer" data-toggle="modal" data-target="#input_tf_spj' . $tor[$m]->id . '"><i class="las la-money-check-alt"></i></button>';
                                                                        ?>
                                                                    @elseif ($b->nama_status == 'Pelunasan Pembayaran/SPJ Selesai')
                                                                        <?php $file = '<a href="' . url('/detail_spj/') . '?idtor=' . base64_encode($tor[$m]->id) . '"><button class="btn btn-sm bg-info rounded-pill" title="Detail File SPJ"><i class="las la-external-link-alt"></i></i></button></a>&nbsp<button class="btn btn-sm bg-success rounded-pill" title="Lihat Bukti Transfer" data-toggle="modal" data-target="#show_tf_spj' . $tor[$m]->id . '"><i class="las la-check"></i></button>';
                                                                        ?>
