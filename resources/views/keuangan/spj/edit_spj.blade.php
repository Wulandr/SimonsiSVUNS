<div class="modal fade" id="edit_spj<?= $tor[$m]->id ?>" aria-labelledby="Edit SPJ" tabindex="-1" role="dialog"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="edit_spj">Input Formulir Surat Pertanggungjawaban (SPJ)</h5>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <input type="text" name="nilai_total" class="form-control" id="validationCustom01"
                                value="{{ $spj[$z]->nilai_total }}" required>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <input type="text" name="nilai_kembali" class="form-control" id="validationCustom01"
                                value="{{ $spj[$z]->nilai_kembali }}" required>
                        </div>
                        <div class="invalid-feedback">
                            Required!
                        </div>
