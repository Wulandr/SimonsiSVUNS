                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    ...
                                    ?>
                                        <div class="nav flex-column nav-pills text-left" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                            <a class="nav-link active" id="spj" data-toggle="pill" href="#list" role="tab" aria-controls="v-pills-home" aria-selected="true">{{ $spj_kategori[$a]->nama_kategori }}</a>
                                        </div>
                                    <?php } ?>
                                </div>
                                ...
                                <div class="col-sm-9">
                                    <div class="tab-content mt-0" id="v-pills-tabContent">
                                        ...
                                        ?>
                                            <div class="tab-pane fade show" id="list" role="tabpanel" aria-labelledby="v-pills-home-tab">
