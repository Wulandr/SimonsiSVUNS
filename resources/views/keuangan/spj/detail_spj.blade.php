<div class="modal fade" id="detail_spj<?= $tor[$m]->id ?>" aria-labelledby="Detail SPJ" tabindex="-1" role="dialog"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="detail_spj">Input Formulir Surat Pertanggungjawaban (SPJ)</h5>
