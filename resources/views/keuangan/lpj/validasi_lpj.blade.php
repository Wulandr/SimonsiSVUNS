                                    ...
                                    @if ($status_keu[$s]->kategori == 'LPJ')
                                        @if ($status_keu[$s]->nama_status === 'Proses Pengajuan')
                                            <?php $tombol =
                                                ...
                                                ')" class="custom-control custom-radio custom-radio-color-checked ">
                                                                                            <input type="radio" name="id_status" id="revisi' .
                                                $tor[$m]->id .
                                                '"
                                                                                                value="13">
                                                                                            <label for="revisi' .
                                                ...
                                                ')"
                                                                                            class="custom-control custom-radio custom-radio-color-checked">
                                                                                            <input type="radio" name="id_status" id="verifikasi' .
                                                $tor[$m]->id .
                                                '"
                                                                                                value="12">
                                                                                            <label for="verifikasi' .
                                                $tor[$m]->id .
                                                '" class=""> Verifikasi</label>
                                                                                        </div>'; ?>
                                        @elseif ($status_keu[$s]->nama_status === 'Revisi')
                                            <?php $tombol =
                                                ...
                                                ')"
                                                                                            class="custom-control custom-radio custom-radio-color-checked">
                                                                                            <input type="radio" name="id_status" id="pengajuan' .
                                                $tor[$m]->id .
                                                '"
                                                                                                value="11">
                                                                                            <label for="pengajuan' .
                                                $tor[$m]->id .
                                                '" class=""> Proses Pengajuan</label>
                                                                                        </div>'; ?>
                                        @elseif ($status_keu[$s]->nama_status === 'Verifikasi')
                                            <?php $tombol =
                                                ...
                                                ')"
                                                                                            class="custom-control custom-radio custom-radio-color-checked">
                                                                                            <input type="radio" name="id_status" id="selesai' .
                                                $tor[$m]->id .
                                                '" value="14">
                                                                                            <label for="selesai' .
                                                $tor[$m]->id .
                                                '" class=""> LPJ Selesai</label>
                                                                                        </div>'; ?>
